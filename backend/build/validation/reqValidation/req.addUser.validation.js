...
exports.reqAddUserValidation = [
    ...
    (req, res, next) => {
        ...
        if (!error.isEmpty()) {
            log_1.default.error(`VALIDATION ERROR : IN : reqAddUserValidation :: ${JSON.stringify(error.array())}`);
